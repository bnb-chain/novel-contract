...
contract Deployer {
    ...
    address public proxyNovel;
    address public implNovel;
    ...
    constructor() {
        ...
        */
        ...
        proxyNovel = calcCreateAddress(address(this), uint8(2));
    ...
    function deploy(
        ...
        require(_isContract(_implNovel), "invalid implNovel");
        implNovel = _implNovel;

        // 1. deploy proxy contract
        address deployedProxyNovel = address(new TransparentUpgradeableProxy(implNovel, proxyAdmin, ""));
        require(deployedProxyNovel == proxyNovel, "invalid proxyNovel address");
        ...
        // 3. init marketplace
        Novel(payable(proxyNovel)).initialize(
